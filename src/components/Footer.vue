<template>
  <footer
    class="flex flex-col justify-center items-center py-16 text-xs text-red-light opacity-70"
  >
    <h4 class="mb-2">
      Built by open source <span role="img">❤️</span> rs. (v{{ version }})
    </h4>
    <p class="mb-2">
      Logo mark made by
      <a
...
export default {
  ...
  setup() {
    return { version: ref(pkg.version) };
  }
};
</script>
